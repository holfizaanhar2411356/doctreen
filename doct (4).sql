...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2026 at 07:38 AM
...
--
-- Table structure for table `lahan_petanis`
--

CREATE TABLE `lahan_petanis` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, '2026_05_09_022844_create_petanis_table', 1),
(5, '2026_05_09_022845_create_admins_table', 1),
(6, '2026_05_09_022845_create_keluhans_table', 1),
(7, '2026_05_09_022845_create_konsultans_table', 1),
(8, '2026_05_09_022846_create_konsultasis_table', 1),
(9, '2026_05_09_022846_create_lahan_petanis_table', 1),
(10, '2026_05_09_022847_create_produks_table', 1),
(11, '2026_05_09_022847_create_tanamen_table', 1),
(12, '2026_05_09_022847_create_tokos_table', 1),
(13, '2026_05_09_022848_create_pesanans_table', 1),
(14, '2026_05_09_022848_create_riwayats_table', 1),
(15, '2026_05_09_022848_create_ulasans_table', 1);
...
--
-- Indexes for table `lahan_petanis`
--
ALTER TABLE `lahan_petanis`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `konsultans`
--
ALTER TABLE `konsultans`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `lahan_petanis`
--
ALTER TABLE `lahan_petanis`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
